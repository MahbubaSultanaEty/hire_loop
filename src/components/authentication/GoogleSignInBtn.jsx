    ...
    >
      <div className=" p-1 rounded-full">
        ...
        >
          ...
          <path
            fill="#4CAF50"
            d="M24 44c5.2 0 10-2 13.5-5.3l-6.2-5.2C29.2 35.1 26.7 36 24 36c-5.3 0-9.7-3.3-11.4-8l-6.5 5C9.4 39.6 16.1 44 24 44z"
          />
          <path
            fill="#1976D2"
            d="M43.6 20.5H42V20H24v8h11.3c-1.1 3-3.2 5.3-6 6.8l6.2 5.2C39.8 36.1 44 30.7 44 24c0-1.3-.1-2.4-.4-3.5z"
          />
        </svg>
      </div>
